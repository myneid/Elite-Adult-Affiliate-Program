<?php
/**
 * Table Definition for tbl_members
 */
require_once 'DB/DataObject.php';

class Tbl_members extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'tbl_members';                     // table name
    ...
    var $Member_ID;                       // int(20)  not_null primary_key auto_increment
    var $Last_Sequence_number;            // string(100)  
    var $AID;                             // int(11)  
    var $Recurring;                       // int(4)  
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('Tbl_members',$k,$v); }
